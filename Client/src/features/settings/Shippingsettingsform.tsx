  ...
  return (
    ...
    >
      ...
      <div className="mt-3 md:mt-6">
        ...
        >
          {t('settings.shippingForm.flatRate')}{' '}
          <span className="text-red-500">*</span>
        </label>
        <div
          className={`mt-2 flex items-center overflow-hidden rounded-xl border ${
            errors.flatRate ? 'border-red-400' : 'border-gray-200'
            ...
            {regions.map((region, i) => (
              ...
              >
                <span className="text-sm text-gray-700">
                  {t(`settings.shippingForm.regions.${region.id}`, {
      ...
      <div className="mt-3 md:mt-6 flex md:justify-end justify-center gap-3">
        ...
        >
          {isPending
            ? t('settings.shippingForm.saving')
            : t('settings.shippingForm.save')}
        </button>
      </div>
    </form>
  );
