...
import type { StandardAttribute, StandardAttributeValue } from '../types';

interface AttributeCardProps {
  attribute: StandardAttribute;
  onEditAttribute: (attribute: StandardAttribute) => void;
  onDeleteAttribute: (attribute: StandardAttribute) => void;
  onAddValue: (attribute: StandardAttribute) => void;
  onEditValue: (attribute: StandardAttribute, value: StandardAttributeValue) => void;
  onDeleteValue: (attribute: StandardAttribute, value: StandardAttributeValue) => void;
}
...
export const AttributeCard = ({
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200/90 shadow-xs hover:shadow-md transition-all duration-200 flex flex-col justify-between overflow-hidden group">
      {/* Top Card Header */}
      <div className="p-5 pb-4 border-b border-gray-100 bg-linear-to-b from-gray-50/70 to-transparent">
