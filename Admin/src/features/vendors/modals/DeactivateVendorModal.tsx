          ...
          >
            ...
            <div className="flex items-start gap-4 mb-5">
              <div className="w-11 h-11 rounded-full bg-red-50 flex items-center justify-center shrink-0">
                <PowerOff size={22} className="text-red-500" strokeWidth={2} />
              </div>
              <div>
                <h2 className="text-base font-bold text-gray-900 leading-tight">
                  {t('vendors.modals.deactivateTitle', 'Deactivate Vendor')}
                </h2>
            ...
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 mb-1.5">
                {t('vendors.modals.deactivateReasonLabel', 'Reason for deactivation')}{' '}
              ...
              <textarea
                ...
                placeholder={t('vendors.modals.deactivateReasonPlaceholder', 'Reason for deactivation...')}
                rows={4}
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-2.5 text-sm font-semibold text-white rounded-lg bg-red-600 hover:bg-red-700 transition-colors cursor-pointer"
              >
                {t('vendors.modals.deactivateBtn', 'Deactivate Vendor')}
              </button>
            </div>
          </motion.div>
        </motion.div>
