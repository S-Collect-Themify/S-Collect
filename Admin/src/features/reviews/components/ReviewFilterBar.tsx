    ...
    <div className="flex flex-wrap items-center gap-3 mb-6">
      ...
      <div className="relative flex-1 min-w-60 max-w-md">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 p-[2px] bg-white border border-gray-200 rounded-xl text-sm text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-black/5 focus:border-gray-400 transition-all rtl:pl-4 rtl:pr-10"
        />
      </div>
