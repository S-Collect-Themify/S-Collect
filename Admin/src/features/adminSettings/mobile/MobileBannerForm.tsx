...
import { Upload, ChevronRight, ChevronLeft, ChevronDown, AlertCircle, CheckCircle2, Loader2 } from 'lucide-react';
    ...
    <div className="space-y-5 w-full pb-8">
          ...
          {linkType === 'CATEGORY' && (
            <div>
              ...
              <div className="relative">
                ...
                <ChevronDown size={14} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none rtl:right-auto rtl:left-3" />
              </div>
          ...
          {linkType === 'EXTERNAL_URL' && (
            <div>
              ...
              <input
                ...
                className={`w-full border rounded-lg px-3 py-2 text-xs text-gray-900 focus:outline-none focus:ring-2 focus:ring-black transition-all ${
      ...
      {confirmEnableModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl max-w-xs w-full p-5 text-center shadow-2xl border border-gray-100 relative">
