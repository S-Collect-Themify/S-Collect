      ...
      <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-xs w-full md:w-3/5">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-sm font-semibold text-gray-900 mb-2 block">Starts At</label>
              <input
                type="datetime-local"
                value={startsAt}
                onChange={(e) => setStartsAt(e.target.value)}
                className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all"
              />
            </div>
            <div>
          ...
          {/* Sort Order */}
          <div>
            <label className="text-sm font-semibold text-gray-900 mb-2 block">Sort Order</label>
            <input
              type="number"
              min="1"
              value={sortOrder}
